...
if (isset($_POST["update"])) {
	...
	$ip_alloted=$PluginAddressingConfig->fields["alloted_ip"];
	$ip_free=$PluginAddressingConfig->fields["free_ip"];
	$ip_reserved=$PluginAddressingConfig->fields["reserved_ip"];
	$ip_double=$PluginAddressingConfig->fields["double_ip"];
	$system=$PluginAddressingConfig->fields["used_system"];
	$ping=$PluginAddressingConfig->fields["use_ping"];
